...
public class SimpleDaoImpl3TTL extends AbstractDaoImpl {

    @Override
    public void save(Person person) {
        //String cql = String.format("INSERT INTO persons(id, name, age) VALUES(%s,'%s', %s)", person.getId(), person.getName(), person.getAge());
        SimpleStatement simpleStatement = SimpleStatement.newInstance("INSERT INTO persons(id, name, age) VALUES(?,?,?) USING TTL 60")
