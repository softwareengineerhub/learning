 ...
 * 
 */
@WebServiceClient(name = "MyCalculatorService", targetNamespace = "http://myws.xml.ch09.app.com/", wsdlLocation = "http://localhost:8089/calc?wsdl")
    ...
    extends Service
{
    ...
    private final static QName MYCALCULATORSERVICE_QNAME = new QName("http://myws.xml.ch09.app.com/", "MyCalculatorService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8089/calc?wsdl");
    ...
    public MyCalculator getMyCalculatorPort() {
        return super.getPort(new QName("http://myws.xml.ch09.app.com/", "MyCalculatorPort"), MyCalculator.class);
    }
    ...
    public MyCalculator getMyCalculatorPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://myws.xml.ch09.app.com/", "MyCalculatorPort"), MyCalculator.class, features);
    }
