...
kafka-avro-console-producer --broker-list 192.168.99.100:9092 --topic
 ...
 --propert value.schema='{"type":"record","name":"myrecord","fields":[{"name":"f1","type":"string"}]}'
 ...
 Consumer:
 kafka-avro-console-consumer --topic
 test-avro --schema.registry.url=http://192.168.99.100:8081 --from-beginning
 ---------------------------------------
 ...
 So, you need to avaoluate schema in compatible way, not just like you want.
