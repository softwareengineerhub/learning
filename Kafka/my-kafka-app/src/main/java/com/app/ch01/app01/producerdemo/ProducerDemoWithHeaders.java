...
public class ProducerDemoWithHeaders {
    ...
    public static void main(String[] args) {
        ...
        record.headers().add(new RecordHeader("currentTime", (""+System.currentTimeMillis()).getBytes()));
        //record.headers().add(new RecordHeader("currentTimeAsBytes", Longs.));
