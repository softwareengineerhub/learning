 ...
 * @author asusadmin
 */
public class ConsumerDemoAdminClient2 {
    
    public static void main(String[] args) throws Exception {
        Logger logger = LoggerFactory.getLogger(ConsumerDemoAdminClient2.class.getName());
        ...
        Map<TopicPartition, Object> mapGroupOffsets = ac.listGroupOffsets(groupId);
        System.out.println(mapGroupOffsets);
