...
@SpringBootTest
public class MyDateRepositoryTest extends AbstractPostgresContainer {
    ...
    void shouldSaveAndFindEntity() {
        ...
        repository.upsert(entity2.id(), entity2.name(), entity2.myDate().toInstant());
        ...
        repository.upsert(entity3.id(), entity3.name(), entity2.myDate().toInstant());
